...
const FrequentlyAsked = () => {
  return (
    <div style={{display:"flex",justifyContent:"center"}} >
        ...
        <div style={{width:"75%"}}>
        <h2 style={{marginTop:"50px",textAlign:"center",color:"#9b1fe9",fontWeight:"600"}}>Frequently Asked Questions</h2>
        <Accordion>
    <AccordionSummary
      ...
      id="panel1a-header"
    >
      <Typography style={{fontFamily:"Varela Round",fontWeight:"600"}}>What is blockchain oracle </Typography>
    </AccordionSummary>
    <AccordionDetails>
  ...
  <Accordion>
    <AccordionSummary
      ...
      id="panel2a-header"
    >
      <Typography style={{fontFamily:"Varela Round",fontWeight:"600"}}>Why do blockchains need oracles</Typography>
    </AccordionSummary>
    <AccordionDetails>
      <Typography style={{fontFamily:"Varela Round"}}>
  ...
  <Accordion>
    <AccordionSummary
      ...
      id="panel2a-header"
    >
      <Typography style={{fontFamily:"Varela Round",fontWeight:"600"}}>What is Chainlink Network</Typography>
    </AccordionSummary>
    <AccordionDetails>
      <Typography style={{fontFamily:"Varela Round"}}>
  ...
  <Accordion>
    <AccordionSummary
      ...
      id="panel2a-header"
    >
      <Typography style={{fontFamily:"Varela Round",fontWeight:"600"}}>Where I can explore the performance and reliability of the chainlink network</Typography>
    </AccordionSummary>
    <AccordionDetails>
      <Typography style={{fontFamily:"Varela Round"}}>
  ...
  <Accordion>
    <AccordionSummary
      ...
      id="panel2a-header"
    >
      <Typography style={{fontFamily:"Varela Round",fontWeight:"600"}}>What is chainlink verifiable Random Function</Typography>
    </AccordionSummary>
    <AccordionDetails>
      <Typography style={{fontFamily:"Varela Round"}}>
  ...
  <Accordion>
    <AccordionSummary
      ...
      id="panel2a-header"
    >
      <Typography style={{fontFamily:"Varela Round",fontWeight:"600"}}>what is chainlink proof of resereve</Typography>
    </AccordionSummary>
    <AccordionDetails>
      <Typography style={{fontFamily:"Varela Round"}}>
      Chainlink VRF brings secure random number generation to the blockchain. Chainlink VRF solves the difficult problem of providing an on-chain source of randomness that is publicly verifiable to be authentic and tamper-proof. Many smart contracts are augmenting the value they can create by utilizing Chainlink VRF, specifically applications such as gaming dApps that must prove to their users that their source of randomness is provably fair and resistant to manipulation from any external entity. Chainlink VRF enables and accelerates the development of smart contracts focused on blockchain gaming, security, layer-two protocols, and various other use cases
  ...
  <Accordion>
    <AccordionSummary
      ...
      id="panel2a-header"
    >
      <Typography style={{fontFamily:"Varela Round",fontWeight:"600"}}>Who can use Chain link</Typography>
    </AccordionSummary>
    <AccordionDetails>
      <Typography style={{fontFamily:"Varela Round"}}>
  ...
  <Accordion>
    <AccordionSummary
      ...
      id="panel2a-header"
    >
      <Typography style={{fontFamily:"Varela Round",fontWeight:"600"}}>How do i keep will with current protocol development</Typography>
    </AccordionSummary>
    <AccordionDetails>
      <Typography style={{fontFamily:"Varela Round"}}>
  ...
  <Accordion>
    <AccordionSummary
      ...
      id="panel2a-header"
    >
      <Typography style={{fontFamily:"Varela Round",fontWeight:"600"}}>Where I can reach out for chain link support</Typography>
    </AccordionSummary>
    <AccordionDetails>
      <Typography style={{fontFamily:"Varela Round"}}>
  ...
  <Accordion>
    <AccordionSummary
      ...
      id="panel2a-header"
    >
      <Typography style={{fontFamily:"Varela Round",fontWeight:"600"}}>How do i participate building chainlink</Typography>
    </AccordionSummary>
    <AccordionDetails>
      <Typography style={{fontFamily:"Varela Round"}}>
